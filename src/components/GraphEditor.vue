<template>
  <draggable v-model="store.nodes" draggable=".item" group="nodes">
    <div v-for="node in store.nodes" :key="node.id" class="item">
      ...
      />
      <input v-model="node.text" type="text" class="nodeInput" />
      <draggable
      ...
      >
        <div v-for="child in node.children" :key="child.id" class="child">
          ...
          />
          <input type="text" v-model="child.text" class="nodeInput" />
        </div>
      </draggable>
    </div>
  </draggable>
